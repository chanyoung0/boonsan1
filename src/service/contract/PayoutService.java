...
public class PayoutService {
    ...
    // 지급유형 텍스트 변환
    public String resolvePaymentTypeLabel(String choice) {
        switch (choice) {
            case "1": return "만기환급금";
            case "2": return "중도인출금";
            case "3": return "해지환급금";
    ...
    // 지급금 산출 금액 반환 (시뮬레이션)
    public BigDecimal calculateAmount(String choice) {
        switch (choice) {
    ...
    // Payout 객체 생성 및 저장
    public Payout savePayout(String processor, String paymentTypeChoice, BigDecimal calculatedAmount) {
